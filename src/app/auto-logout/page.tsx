...
import { clearAutoLogoutInfo, getAutoLogoutInfo, type AutoLogoutInfo } from "@/lib/auto-logout";
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="text-2xl font-semibold tracking-normal">Logged out from this device</h1>
        ...
        {info?.loggedInOn ? (
          <div className="mt-6 w-full rounded-lg border border-neutral-800 bg-neutral-900 px-4 py-3 text-left">
            <p className="text-xs uppercase tracking-wide text-neutral-500">Logged in on</p>
            <p className="mt-1 text-sm font-medium text-neutral-100">{info.loggedInOn}</p>
          </div>
        ) : null}
