          ...
          <form onSubmit={handleSubmit} className="space-y-6 max-md:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 z-[1]" />
                  <Input
                    id="purchasePrice"
                    type="number"
                    step="0.01"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded-md text-white placeholder-gray-400 resize-none"
