...
} from "@/components/realtime/realtime-inventory";
import {
  DeleteConfirmation,
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-1">
              Track stock levels with real-time updates and manage inventory
            </p>
          </div>
        ...
        {showConsolidated && (
          <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4">
            <div className="flex items-center gap-2 text-blue-400">
              ...
              <p className="text-sm">
                <strong>Consolidated View:</strong> Same items from the same
                brand are grouped together. Total quantities are combined, and
                the latest purchase/selling prices are displayed.
              </p>
            </div>
          </div>
        )}
