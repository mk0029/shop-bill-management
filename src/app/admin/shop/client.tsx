    ...
    <div className="space-y-3">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          <h1 className="text-lg sm:text-xl font-bold text-white">Online Shop</h1>
          <div className="flex items-center gap-2">
            <Button onClick={() => router.push("/admin/shop/categories")} variant="outline" size="sm" className="gap-1.5">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between px-0.5">
          <span className="text-[10px] sm:text-xs text-gray-500">
            {sortedCategories.length} categories &middot; {filtered.length} items
          </span>
        </div>
