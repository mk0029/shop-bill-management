      ...
      <div className="flex items-center justify-between">
        <div className="min-w-0 flex-1">
          ...
          <p className="text-gray-400 mt-1 text-sm sm:text-base">
            Manage and complete your saved draft bills
          </p>
        </div>
        <Button
          onClick={() => {
                ...
                >
                  <div className="min-w-0">
                    ...
                    <p className="text-gray-300 text-sm truncate">
                      {details[d.id]?.billerName || "Unknown"} •{" "}
                      {details[d.id]?.serviceType || "sale"} •{" "}
                      {details[d.id]?.itemCount ?? 0} items •{" "}
                      {fmtCurrency(details[d.id]?.total ?? 0)}
                    </p>
                    <p className="text-gray-500 text-xs truncate">
                      {details[d.id]?.phone ? `${details[d.id]?.phone} • ` : ""}
                      {details[d.id]?.billDate
                        ? `Bill Date: ${details[d.id]?.billDate} • `
                        : ""}
