...
// Reads service account from env var FIREBASE_SERVICE_ACCOUNT_JSON (stringified JSON)
// Falls back to GOOGLE_APPLICATION_CREDENTIALS file path if provided (local dev)
function getGoogleAuth(): GoogleAuth {
  ...
  // Fallback: rely on GOOGLE_APPLICATION_CREDENTIALS file path
  return new GoogleAuth({
    scopes: ['https://www.googleapis.com/auth/firebase.messaging'],
  })
}
