    ...
    if (paymentEventType) {
      ...
      events.push({
        ...
        payload: {
          ...
          advanceApplied: toNum(body.advanceApplied) || 0,
          advanceCreated: toNum(body.advanceCreated) || 0,
          paymentBeforeAdvance: toNum(body.paymentBeforeAdvance) || 0,
          finalCustomerPayment: toNum(body.finalCustomerPayment) || 0,
          updatedAt,
