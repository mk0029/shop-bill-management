    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[220] flex items-center justify-center p-3"
        >
          <div
          ...
          <motion.div
            ...
            className="relative bg-gray-900 border border-white/[0.08] rounded-xl w-full max-w-lg max-h-[85dvh] flex flex-col shadow-2xl backdrop-blur-2xl"
