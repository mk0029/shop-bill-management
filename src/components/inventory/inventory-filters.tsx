...
export const InventoryFilters = ({
  ...
  return (
     ...
     <ResponsiveAccordion removePX title={ <CardHeader className="!py-0 !px-0">
        <CardTitle className="text-white flex items-center gap-2">
          <Filter className="dm:w-5 md:h-5 h-4 w-4" />
          Filters & Search
        </CardTitle>
      </CardHeader>}> <CardContent className="space-y-4 !pt-3">
        {/* Search */}
