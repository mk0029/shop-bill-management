...
export function useFittingRates(initialRates?: FittingRates | null) {
  const [rates, setRates] = useState<FittingRates | null>(initialRates ?? null);
...
export function FittingCalculator({
  ...
  const { rates, loading, error, setRates } = useFittingRates(initialRates);
    ...
    <div className="space-y-4">
      ...
      <Card className="bg-gray-900 border-gray-800">
        ...
        <CardContent className="space-y-4 text-gray-300">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setRates((r) => ({
                        ...
                        underground: safeNum(e.target.value),
                      }))
                    }
                  />
                </div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setRates((r) => ({
                        ...
                        open_pvc: safeNum(e.target.value),
                      }))
                    }
                  />
                </div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setRates((r) => ({
                        ...
                        open_wire: safeNum(e.target.value),
                      }))
                    }
                  />
                </div>
          ...
          {/* Loading / Error */}
          {loading && (
            <div className="text-gray-400 text-sm">Loading rates...</div>
          )}
