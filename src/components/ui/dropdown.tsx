...
export function Dropdown({
  ...
  return (
    <div
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-1 bg-gray-800 border border-gray-700 rounded-lg shadow-2xl shadow-black/50 z-50 max-h-60 sm:max-h-60 overflow-hidden pb-2">
          {isSearchAvialable && (
          ...
          <div className="max-h-48 overflow-auto pb-3">
