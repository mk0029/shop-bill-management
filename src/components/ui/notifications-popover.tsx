        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 z-50 bg-black/70 backdrop-blur-2xl h-screen w-full"
            ...
            <motion.div
              ...
              transition={{ duration: 0.15 }}
              className="fixed sm:absolute top-14 sm:top-auto right-3 sm:right-0 sm:mt-2 w-[calc(100vw-24px)] sm:w-[90vw] max-w-sm bg-gray-900 border border-gray-800 rounded-lg shadow-xl z-[60]"
              role="dialog"
