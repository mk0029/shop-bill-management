      ...
      <div className="bg-gray-900 border border-gray-800 rounded-lg divide-y divide-gray-800">
        {items.length === 0 ? (
          ...
          items.map((n) => {
            ...
            const customerFromUsers = customerId ? users?.get?.(customerId) : undefined
            const derivedUser = n?.meta?.user || customerFromBill || customerFromUsers
            ...
            return (
              <div key={n.id} className="p-4 flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-400 text-sm whitespace-pre-line">{displayBody}</p>
