...
export const landingTranslations: Record<LandingLanguage, TranslationTree> = {
  en: {
    ...
    form: {
      ...
      other: "Other (type village name)",
      customLocationPlaceholder: "Type your village name",
      contactPreference: "Contact Preference",
      whatsapp: "WhatsApp",
      email: "Email",
      serviceRequirement: "Service Requirement",
      serviceRequirementPlaceholder: "Tell us what you need",
      validationRequired: "Please fill name, phone, email, and location.",
      ...
      emailSuccess: "Your request has been submitted. It may take some time to create your account. We will inform you soon.",
    ...
    share: {
      title: "Share Login URL",
      customerName: "Customer Name",
      customerNamePlaceholder: "Customer name",
      customerPhone: "Customer Phone",
      customerPhonePlaceholder: "e.g. 9876543210",
      secretKey: "Secret Key",
      secretKeyPlaceholder: "Customer secret key",
      validationRequired: "Please fill phone and secret key.",
      sendWhatsApp: "Send via WhatsApp",
      sendEmail: "Send via Email",
      emailSubject: "Your Account Login Details",
      contactDefault: "Contact the shop from the app chat",
    },
  },
  hi: {
    common: {
    ...
    form: {
      ...
      other: "अन्य (गाँव का नाम लिखें)",
      customLocationPlaceholder: "अपने गाँव का नाम लिखें",
      contactPreference: "संपर्क का तरीका",
      whatsapp: "व्हाट्सऐप",
      email: "ईमेल",
      serviceRequirement: "सेवा की जरूरत",
      serviceRequirementPlaceholder: "आपको कौन सा काम करवाना है?",
      validationRequired: "कृपया नाम, फोन, ईमेल और स्थान भरें।",
      ...
      emailSuccess: "आपका अनुरोध सबमिट कर दिया गया है। आपका अकाउंट बनने में कुछ समय लग सकता है। हम जल्द ही आपको सूचित करेंगे।",
    ...
    share: {
      title: "लॉगिन URL साझा करें",
      customerName: "ग्राहक का नाम",
      customerNamePlaceholder: "ग्राहक का नाम",
      customerPhone: "ग्राहक का फोन",
      customerPhonePlaceholder: "जैसे 9876543210",
      secretKey: "गुप्त कुंजी",
      secretKeyPlaceholder: "ग्राहक की गुप्त कुंजी",
      validationRequired: "कृपया फोन और गुप्त कुंजी भरें।",
      sendWhatsApp: "व्हाट्सऐप पर भेजें",
      sendEmail: "ईमेल से भेजें",
      emailSubject: "आपके अकाउंट की लॉगिन जानकारी",
      contactDefault: "ऐप चैट से दुकान से संपर्क करें",
    },
  },
};
