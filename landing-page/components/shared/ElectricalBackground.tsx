    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 20% 50%, rgba(56,189,248,0.03) 0%, transparent 50%), radial-gradient(ellipse at 80% 20%, rgba(139,92,246,0.02) 0%, transparent 50%), radial-gradient(ellipse at 50% 80%, rgba(129,140,248,0.02) 0%, transparent 50%)",
          }}
        />
        <div
